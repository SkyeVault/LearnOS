...
export function renderHome() {
  ...
  getApp().innerHTML = `<div class="page classic-learning-home" data-home-style="${homeStyle}"><div class="bg-shapes">${floatingShapes}</div><header class="header"><div class="home-tools"><button class="back-btn" id="switch-learner">Exit</button></div><div class="home-settings-tools"><button class="back-btn" id="open-living-library">Living Library</button><button class="back-btn" id="open-family-hub">Family Hub</button><button class="back-btn" id="open-design-center">Design Center</button><button class="back-btn" id="open-learner-settings">Theme & home</button></div><div class="title-name">${titleLetters}</div><div class="title-sub">0.26</div><div class="subtitle">What do you want to learn today?</div></header><div class="subjects-grid">${cardHtml}</div></div>`
